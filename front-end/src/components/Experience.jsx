  ...
  return (
    ...
    <section className="p-3">
      <div>
        ...
        <h2 className="text-2xl font-semibold">Code Platoon - Student</h2>
    ...
    <section className="p-3">
      <div className="flex justify-between">
            <h2 className="text-2xl font-semibold">Yonsei Korean Language Institute</h2>
    ...
    <section className="p-3">
      <div>
        <div className="flex justify-between">
            <h2 className="text-2xl font-semibold">Florida State University</h2>
